...
# [Muller](muller.h)
This method use a quadratic aproximation finding that makes the function equal 0, this version only works on real numbers but in future, this´ll be expand to complex numbers too.